      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {courses.map((course, idx) => (
            ...
            >
              {/* Tag */}
              <span className={`absolute top-4 left-4 text-xs font-semibold px-3 py-1 rounded-full z-10 ${
                course.tag === "Best Seller" ? "bg-yellow-400 text-black" :
        ...
        <motion.div 
          ...
          className="mt-12"
        >
          {/* <button className="px-8 py-3 bg-white text-indigo-600 border border-indigo-600 rounded-full font-semibold hover:bg-indigo-600 hover:text-white transition-colors duration-300 shadow-md">
            View All Courses
          </button> */}
        </motion.div>
      </div>
